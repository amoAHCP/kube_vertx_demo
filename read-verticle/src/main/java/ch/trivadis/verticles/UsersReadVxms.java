...
public class UsersReadVxms extends VxmsEndpoint {
    Logger log = Logger.getLogger(UsersReadVerticle.class.getName());
    ...
    public static void main(String[] args) {
        ...
        Vertx.clusteredVertx(vOpts, cluster -> {
            if (cluster.succeeded()) {
                ...
                result.deployVerticle(UsersReadVxms.class.getName(), options, handle -> {
