...
public class UsersWriteVxms extends VxmsEndpoint {
    Logger log = Logger.getLogger(UsersWriteVerticle.class.getName());
    ...
    public static void main(String[] args) {
        ...
        Vertx.clusteredVertx(vOpts, cluster -> {
            if (cluster.succeeded()) {
                ...
                result.deployVerticle(UsersWriteVxms.class.getName(), options, handle -> {
